...
export const es: MovementTranslations = {
  renaissance: {
    summary: `El Renacimiento — término que en francés significa "renacimiento" — fue una de las revoluciones culturales más transformadoras de la historia humana. Nacido en las ciudades-estado de la Italia del siglo XIV, particularmente en Florencia, representó un redescubrimiento integral de la Antigüedad Clásica y una reinvención radical de lo que el arte podía ser. Tras casi un milenio en el que el arte medieval había priorizado el simbolismo espiritual sobre la realidad física, los artistas renacentistas volvieron su mirada hacia el mundo observable con una pasión que rozaba lo científico.

En el corazón del Renacimiento latía el Humanismo — un movimiento filosófico que situaba al ser humano, en lugar de la autoridad divina, en el centro de la vida intelectual. Artistas y pensadores estudiaron textos, esculturas y arquitectura griegos y romanos antiguos no como reliquias históricas, sino como modelos vivos para una nueva civilización. Este cambio tuvo profundas consecuencias para el arte visual: las figuras se volvieron anatómicamente verosímiles, los paisajes retrocedían de forma convincente en la distancia y las emociones se representaban con hondura psicológica.

El movimiento se desarrolló en fases distintas. El Renacimiento Temprano (aproximadamente 1400–1490), centrado en Florencia, fue donde artistas como Botticelli y Masaccio sentaron las bases. El Alto Renacimiento (1490–1527), dominado por Leonardo, Miguel Ángel y Rafael, representó la cima del logro técnico y la belleza idealizada. El Renacimiento Tardío, o Manierismo (posterior a 1527), vio a los artistas distorsionar deliberadamente los ideales renacentistas — alargando figuras, intensificando colores e introduciendo inquietud emocional — como respuesta a la turbulencia política y religiosa.

Dos inventos técnicos definieron el lenguaje visual de la época por encima de todo: la perspectiva lineal, que creó la ilusión matemática de un espacio tridimensional sobre una superficie plana, y el claroscuro, el dominio de la luz y la sombra para modelar la forma tridimensional. Juntos dotaron a las pinturas renacentistas de un sentido del peso, la profundidad y el drama nunca visto antes. El óleo, que fue reemplazando gradualmente a la témpera, permitió a los artistas acumular capas traslúcidas de color, logrando un realismo luminoso que aún hoy asombra a los espectadores.`,

    characteristics: [
      'Perspectiva lineal — sistema matemático para crear la ilusión de profundidad sobre una superficie plana',
      'Claroscuro — contrastes dramáticos de luz y sombra para modelar la forma tridimensional',
      'Sfumato — técnica de Leonardo que difumina los contornos con transiciones suaves y ahumadas',
      'Precisión anatómica — figuras basadas en la observación directa y la disección del cuerpo humano',
      'Humanismo — filosofía que sitúa la experiencia humana, la razón y la belleza en el centro del arte',
      'Renacimiento clásico — estudio directo y reinterpretación de los modelos griegos y romanos antiguos',
      'Naturalismo idealizado — belleza enraizada en la observación pero elevada hacia una forma ideal',
      'Pintura al óleo — veladuras superpuestas que permiten profundidad de color luminosa y sutil textura',
      'Técnica del fresco — pintura mural a gran escala sobre yeso húmedo, dominada para espacios arquitectónicos',
      'Composición triangular — figuras dispuestas en estructuras piramidales estables para la armonía visual',
      'Retrato psicológico — rostros y gestos que transmiten estados emocionales interiores',
      'Cultura del mecenazgo — familias adineradas como los Medici financiando el arte como prestigio político y espiritual',
      'Temas seculares junto a los religiosos — mitología, retrato y alegoría ganando prominencia',
      'Integración arquitectónica — pinturas y esculturas diseñadas en diálogo con sus espacios',
    ],
    ...
    artists: [
      {
        ...
        years: '1452 – 1519',
        description: 'El arquetípico "hombre del Renacimiento", Leonardo era simultáneamente pintor, anatomista, ingeniero, músico y teórico. Sus cuadernos — repletos de disecciones, inventos mecánicos y estudios del agua, la luz y la botánica — revelan una mente impulsada por una curiosidad insaciable. En pintura, llevó la técnica del sfumato a su cima: los bordes de las formas se disuelven en una neblina atmosférica, dando a figuras como la Mona Lisa una presencia inefable. Su Última Cena revolucionó la pintura narrativa al usar la arquitectura, el gesto y la tensión psicológica para dramatizar un único momento congelado. Leonardo completó relativamente pocas pinturas, pero cada una alteró fundamentalmente el curso de la historia del arte.',
      },
      {
        name: 'Michelangelo Buonarroti',
        years: '1475 – 1564',
        description: 'Miguel Ángel se acercó a cada material con la ferocidad de un hombre que creía que el arte era un acto de liberación espiritual. Como escultor, su concepto del "non-finito" — dejar partes del mármol sin tallar — sugería figuras que luchaban por emerger de la piedra en bruto. Su David es la declaración renacentista suprema sobre el cuerpo humano heroico: cada músculo, vena y tendón rendido con precisión anatómica y cargado de tensión psicológica. En el techo de la Capilla Sixtina, pintado casi en su totalidad en solitario a lo largo de cuatro años, comprimió todo un universo teológico en unas 500 figuras. En su carrera tardía, su estilo se volvió cada vez más atormentado y espiritual, anticipando la intensidad emocional del Manierismo y el Barroco.',
      },
      {
        name: 'Raphael Sanzio',
        years: '1483 – 1520',
        description: 'Donde Leonardo sondeaba y Miguel Ángel luchaba, Rafael hacía que todo pareciera sin esfuerzo. Sus pinturas irradian una armonía serena y luminosa que representa quizás la expresión más pura de los ideales renacentistas. Sus Madonnas elevaron el femenino sagrado a través de un equilibrio compositivo perfecto y una tibieza psicológica tierna. La Escuela de Atenas — un vasto fresco en las Estancias del Vaticano — organizó a los grandes filósofos de la Antigüedad en un espacio teatral y arquitectónicamente convincente, escribiendo efectivamente una enciclopedia visual del conocimiento humano. Rafael murió a los 37 años, pero su influencia en el sentido de gracia y belleza de la pintura occidental persistió durante siglos.',
      },
      {
        name: 'Sandro Botticelli',
        years: '1445 – 1510',
        description: 'La obra de Botticelli ocupa un lugar único en el Renacimiento: profundamente personal, ricamente simbólica y visualmente diferente a cualquier otra. Sus figuras tienen un alargamiento de otro mundo y una gracia melancólica que las distingue del naturalismo más terrenal de sus contemporáneos. El Nacimiento de Venus y la Primavera se encuentran entre las primeras pinturas mitológicas a gran escala del arte occidental — encargadas por los Medici y saturadas de filosofía neoplatónica sobre el amor, la belleza y el alma. En su vida posterior, bajo la influencia del predicador Savonarola, supuestamente destruyó muchas de sus obras seculares y su estilo se volvió austero y espiritual.',
      },
      {
        name: 'Titian (Tiziano Vecellio)',
        years: 'c. 1488 – 1576',
        description: 'El maestro indiscutible de la pintura veneciana, Tiziano transformó el óleo en algo casi mágico. Sus pinceladas sueltas y gestuales — aplicadas en docenas de capas traslúcidas — creaban superficies que parecían brillar desde dentro, capturando la textura de la piel, la seda, la armadura y el follaje con igual virtuosismo. Mientras el Renacimiento florentino valoraba la línea y el disegno (dibujo), la tradición veneciana defendía el colore (color), y Tiziano era su exponente supremo. Sus obras tardías, pintadas cuando tenía más de ochenta años, se encuentran entre las pinturas más proto-impresionistas de la historia del arte. Sus retratos de papas, emperadores y nobles definieron el lenguaje visual del poder durante un siglo.',
      },
      {
        name: 'Albrecht Dürer',
        years: '1471 – 1528',
        description: 'El Renacimiento del Norte encontró su mayor voz en Dürer, un artista alemán que realizó múltiples viajes a Italia y sintetizó el conocimiento italiano sobre espacio y anatomía con la tradición noreuropea de observación meticulosa y naturalismo intenso. Sus autorretratos — seguros, casi cristológicos — fueron declaraciones radicales de identidad y dignidad artística. Como grabador, elevó el grabado en madera y el aguafuerte al nivel de las bellas artes. Su Melancolía I es una de las imágenes más analizadas del arte occidental, densa en simbolismo sobre la creatividad, el conocimiento y la melancolía. Dürer llevó el Renacimiento al norte de Europa prácticamente en solitario.',
      },
    ],
    ...
    artworks: [
      {
        title: 'Mona Lisa',
        description: 'La pintura más reconocida del mundo. El dominio del sfumato por parte de Leonardo da a la figura una presencia etérea y atmosférica. La sonrisa ambigua y la mirada directa han fascinado a los espectadores durante cinco siglos.',
      },
      {
        title: 'The Creation of Adam',
        description: 'La icónica imagen de Dios tendiendo la mano hacia Adán representa el pináculo de la pintura figurativa renacentista. La tensión de la composición entre dos manos extendidas — casi pero no del todo tocándose — es uno de los gestos más poderosos de la historia del arte.',
      },
      {
        title: 'The Birth of Venus',
        description: 'Una de las primeras grandes pinturas mitológicas del Renacimiento. La Venus de Botticelli encarna el ideal neoplatónico de la belleza divina — su forma elegante y alargada emergiendo del mar en un remolino de viento, flores y telas.',
      },
      {
        title: 'The School of Athens',
        description: 'El logro supremo de Rafael en composición. Todos los grandes filósofos de la Antigüedad se reúnen bajo un vasto arco clásico — Platón y Aristóteles en el centro, rodeados de Sócrates, Pitágoras, Euclides y Diógenes. Una enciclopedia visual del conocimiento humano.',
      },
      {
        title: 'David',
        description: 'La declaración definitiva del ideal renacentista del cuerpo humano heroico. Miguel Ángel capturó a David en el momento anterior a la batalla — tenso de energía, cada músculo y vena representados con precisión anatómica. Con 5,17 metros, domina cualquier espacio que habita.',
      },
      {
        title: 'The Last Supper',
        description: 'Leonardo revolucionó la pintura narrativa al congelar el preciso momento en que Cristo anuncia su traición. La reacción de cada apóstol es psicológicamente distinta. La perspectiva arquitectónica lleva la mirada directamente al rostro de Cristo, convirtiéndolo en el centro sereno de una tormenta emocional.',
      },
      {
        title: 'Primavera',
        description: 'Una obra alegórica densa, saturada de simbolismo neoplatónico. Nueve figuras mitológicas habitan un bosque de naranjos — Venus, las Tres Gracias, Mercurio, Flora, Céfiro y Cloris. Las líneas fluyentes y los gestos entrelazados crean un tapiz visual de extraordinaria elegancia.',
      },
      {
        title: 'Vitruvian Man',
        description: 'La imagen definitiva renacentista de la proporción humana. Basado en los escritos del arquitecto romano Vitruvio, Leonardo inscribió la figura masculina ideal dentro de un círculo y un cuadrado — demostrando la relación entre la geometría humana y la geometría del cosmos.',
      },
      {
        title: 'The Arnolfini Portrait',
        description: 'Un hito de la pintura del Renacimiento del Norte. El dominio del óleo de Van Eyck creó una superficie de detalle exquisito — cada textura desde el terciopelo hasta el latón y la piel representada con impresionante precisión. El espejo convexo del fondo refleja toda la habitación, incluidos dos misteriosos testigos.',
      },
      {
        title: "St. Peter's Basilica",
        description: 'El mayor logro arquitectónico del Renacimiento. La cúpula de Miguel Ángel — diseñada cuando tenía 72 años — se convirtió en el modelo para la arquitectura de cúpulas en todo el mundo. La basílica sintetiza un siglo de pensamiento arquitectónico renacentista en un único monumento abrumador a la ambición y la fe humanas.',
      },
    ],

    tattooTips: {
      intro: `El Renacimiento es una de las fuentes más ricas de las que puede beber un tatuador — no solo por sus imágenes icónicas, sino por su filosofía técnica subyacente. Los maestros de este período resolvieron exactamente los problemas que enfrenta todo tatuador: cómo crear la ilusión de volumen sobre una superficie plana, cómo hacer que una figura parezca viva, cómo organizar composiciones complejas en algo visualmente armonioso. Entender cómo trabajaban se aplica directamente a la aguja.`,
      design: [
        'Estudia la composición triangular: los maestros renacentistas organizaban las figuras en estructuras piramidales o triangulares para crear estabilidad visual y guiar la mirada. Este principio se traduce perfectamente al emplazamiento corporal — envuelve una composición alrededor de las formas triangulares naturales del hombro, el pecho o la rodilla.',
        'Usa el enmarcado arquitectónico: Rafael y Leonardo frecuentemente situaban figuras dentro de arcos, columnas o marcos de ventana. Para piezas de manga o espalda, considera crear un "escenario" arquitectónico que dé a la escena un sentido de lugar y grandiosidad.',
        'Domina la pose en contrapposto: las figuras del arte renacentista adoptan el contrapposto — peso en una pierna, caderas y hombros inclinados en direcciones opuestas — dando al cuerpo una curva en S natural y viva. Al diseñar figuras, evita la simetría estática; usa esta tensión en S para aportar energía a la composición.',
        'Referencia los estudios de drapeado: los artistas renacentistas se obsesionaban con la forma en que la tela cae y se pliega. El drapeado crea ritmo, enmarca la figura y añade complejidad visual sin competir con el rostro o el punto focal. Incorpora telas fluyentes a retratos o trabajos figurativos para añadir movimiento.',
        'Incorpora la perspectiva atmosférica: los fondos se pintaban progresivamente más claros y azulados en la distancia para sugerir profundidad. En el tatuaje en blanco y negro, usa valores progresivamente más claros y bordes más suaves para los elementos del fondo con el fin de empujarlos hacia atrás y hacer que el primer plano destaque.',
        'Extrae de temas mitológicos: escenas como El nacimiento de Venus, Perseo o las Tres Gracias ofrecen contenido narrativo atemporal con resonancia emocional universal — ideales para piezas a gran escala donde el cliente quiere significado además de belleza.',
        'Explora las convenciones del retrato: el retrato renacentista usaba vistas en tres cuartos — ni completamente frontal ni de perfil — para capturar la personalidad y la dimensión simultáneamente. Este sigue siendo el ángulo más favorecedor y dinámico para los tatuajes de retrato.',
        'Usa las manos deliberadamente: los maestros renacentistas consideraban las manos tan expresivas como el rostro. Estudia las manos en obras de Leonardo y Rafael — extendidas, señalando, entrelazadas — e incorpora manos expresivas a los tatuajes figurativos para amplificar la narración emocional.',
      ],
      technical: [
        'El claroscuro es tu herramienta más importante: todo el modelo de forma del Renacimiento se construye sobre la transición de la luz a la sombra. En el tatuaje, esto significa entender cómo construir un rango de valores completo desde blancos brillantes iluminados hasta negros profundos y saturados — con una gradación suave y controlada a lo largo de todo el proceso.',
        'Piensa en capas, no en líneas: los pintores renacentistas construían la forma a través de veladuras transparentes, cada capa modificando la anterior. Del mismo modo, aborda el sombreado en múltiples pasadas — establece primero tus negros más profundos, luego construye los tonos medios, luego trabaja de vuelta hacia los realces con pasadas más claras y presión de aguja reducida.',
        'La suavidad del borde es tan importante como la oscuridad de la sombra: sfumato significa "ahumado" — los límites entre luz y oscuridad están difuminados, no marcados. Practica para lograr un sombreado con látigo fluido y largas transiciones emplumadas. Un borde duro donde debería haber uno suave aplana instantáneamente la forma.',
        'Estudia la anatomía muscular directamente: Miguel Ángel diseccionó cadáveres para entender el cuerpo. Si tatúas trabajo figurativo, invierte tiempo en anatomía — entiende cómo los músculos se superponen, cómo la piel se estira sobre el hueso, cómo los depósitos de grasa cambian el contorno.',
        'Replica la luminosidad de las veladuras al óleo con capas de tinta: Tiziano lograba tonos de piel luminosos a través de docenas de capas de color transparentes. En el tatuaje de realismo de color, construye los tonos de piel de manera similar — tonos cálidos de base primero, veladuras más frías por encima, realces al final.',
        'Maneja el espacio negativo deliberadamente: las composiciones renacentistas usaban los fondos oscuros para hacer que las figuras claras emergieran dramáticamente. En el tatuaje, oscurece los fondos lo suficiente como para que el sujeto genuinamente "levante" de la piel.',
        'Usa una estructura de valores restringida para piezas grandes: las pinturas renacentistas logran armonía en parte porque limitan sus extremos tonales — el negro más oscuro y la luz más brillante se reservan para el área focal más importante. En grandes composiciones de tatuaje, resiste el impulso de poner el máximo contraste en todas partes.',
        'Estudia específicamente los grabados de Durero para la técnica en blanco y negro: Durero logró una extraordinaria gama tonal en tinta negra pura a través del sombreado cruzado y el puntillismo sistemáticos. Sus grabados son esencialmente manuales avanzados para construir forma con un solo pigmento — directamente aplicables al realismo en blanco y negro.',
      ],
      inspiration: `Los tatuadores contemporáneos que trabajan en estéticas renacentistas tienden a dividirse en dos campos: los que buscan recreaciones hiperrealistas de obras maestras específicas (el techo de la Capilla Sixtina, la Venus de Botticelli) como piezas completas de espalda o mangas, y los que abstraen los principios visuales de la época en su propio estilo figurativo. Este segundo enfoque — internalizar el claroscuro, el contrapposto y la composición clásica sin copiar literalmente pinturas — tiende a producir el trabajo más duradero y personal. Artistas como Chucho Ochoa y Nikko Hurtado demuestran cómo los principios de modelado de luz renacentistas pueden aplicarse al retrato contemporáneo. Para conceptos de manga, considera organizar la progresión de figuras humanas desde el Renacimiento Temprano hasta el Alto Renacimiento a lo largo del brazo — como una línea de tiempo visual del propio Renacimiento.`,
    },

    quiz: [
      {
        question: '¿Qué arquitecto renacentista fue el primero en codificar y utilizar sistemáticamente la perspectiva lineal?',
        options: ['Filippo Brunelleschi', 'Leon Battista Alberti', 'Donato Bramante', 'Andrea Palladio'],
      },
      {
        question: '¿Cómo se llama la técnica de Leonardo da Vinci para crear transiciones suaves y ahumadas entre la luz y la sombra?',
        options: ['Claroscuro', 'Sfumato', 'Impasto', 'Fresco'],
      },
      {
        question: '¿Qué movimiento filosófico situó al ser humano en el centro de la vida intelectual y artística del Renacimiento?',
        options: ['Nihilismo', 'Humanismo', 'Escolasticismo', 'Positivismo'],
      },
      {
        question: '¿Quién pintó los frescos del techo de la Capilla Sixtina en el Vaticano?',
        options: ['Rafael', 'Leonardo da Vinci', 'Miguel Ángel', 'Tiziano'],
      },
      {
        question: '¿En qué ciudad italiana nació el Renacimiento?',
        options: ['Roma', 'Venecia', 'Florencia', 'Milán'],
      },
      {
        question: '¿A qué se refiere el "contrapposto" en el dibujo de figuras renacentista?',
        options: [
          'Una técnica para pintar sobre yeso húmedo',
          'Una pose donde el peso se desplaza a una pierna, creando inclinaciones opuestas en caderas y hombros',
          'El uso del pan de oro en las pinturas sobre tabla',
          'Un método para moler pigmentos para la pintura al óleo',
        ],
      },
      {
        question: '¿Qué maestro renacentista se asocia principalmente con la tradición veneciana del colore — priorizando el color sobre la línea?',
        options: ['Miguel Ángel', 'Rafael', 'Durero', 'Tiziano'],
      },
      {
        question: '¿Qué significa literalmente el término "Renacimiento"?',
        options: ['Nuevo Comienzo', 'Renacimiento', 'Iluminación', 'Revolución'],
      },
      {
        question: '¿Qué adinerada familia florentina se asocia más con el mecenazgo de las artes del Renacimiento?',
        options: ['Los Borgia', 'Los Sforza', 'Los Medici', 'Los Visconti'],
      },
      {
        question: '¿Por qué es significativo Albrecht Durero principalmente en el contexto del Renacimiento?',
        options: ['España', 'Francia', 'Inglaterra', 'Europa del Norte'],
      },
    ],
  },
